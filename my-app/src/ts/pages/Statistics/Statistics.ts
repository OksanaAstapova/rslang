...
class SprintPage extends Page {
  render() {
    ...
    statisticDay.append(learnedWords, correctAnswear);
    ...
    const correctAnswearNumber = new Component("b", "day-words__number", "0").node;
    ...
    const statisticGamesIn = new Component("div", "statistics__day-in", "").node;
    ...
    gameSprint.append(gameAudiocallTitle, gameAudiocallLeaned, gameAudiocallCorrect, gameAudiocallLong);
